import Engine from 'https://cdn.jsdelivr.net/gh/acasi-io/webflow-scripts/simulators/6.5.6-remuneration-independants/node_modules/publicodes/dist/index.js';
import rules from 'https://cdn.jsdelivr.net/gh/acasi-io/webflow-scripts/simulators/6.5.6-remuneration-independants/node_modules/modele-social/dist/index.js';
...
function calculDividendsPfu(turnoverMinusCost, remuneration, cotisationsAmount) {
    ...
    if (eurlDividendsBrut < (shareCapital * 0.1)) {
        ...
        eurlDividendsPfu = Math.round((eurlDividendsBrut - cotisationsOnDividendsAmount) - ((tenPercentShareCapital * 0.3) + ((eurlDividendsBrut - tenPercentShareCapital) * 0.128)));
    }
