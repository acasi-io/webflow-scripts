import Engine from 'https://cdn.jsdelivr.net/gh/acasi-io/webflow-scripts/simulators/6.3.3-remuneration-independants/node_modules/publicodes/dist/index.js';
...
function fillSasuComparison() {
    ...
    document.querySelectorAll('.sasu_comparison_wage').forEach((element) => {
        element.textContent = sasuRemuneration.toLocaleString('fr-FR');
    });
